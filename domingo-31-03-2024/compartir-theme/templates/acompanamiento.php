    <section class="descubreSection acpt" id="acompa">
        <h2 class="titleSectionacpt reveal fade-bottom">ACOMPAÑAMIENTO</h2>
        <div class="CardsSectionacpt">
            <div class="itemSectionDescubreacpt directivosItemacpt reveal fade-left">
            ...
            <div class="itemSectionDescubreacpt docentesItemacpt reveal fade-bottom">
                <div class="topSectionCardacpt">
                    <h2>ACTIVA</h2>
            ...
            <div class="itemSectionDescubreacpt familasItemacpt reveal fade-right">
                <div class="topSectionCardacpt">
                    <h2>FACILITA</h2>
            ...
            <div class="itemSectionDescubreacpt familasItemacptTransforma reveal fade-bottom">
                <div class="">
                ...
                <div class="contentCardsacpt">
                    <div class="rowCards23">
                        ...
                        <div class="botonBoxSecuencia">
                            <a href="<?php the_field('video_transforma') ?>" target="_blank">
                                <button><img src="<?php echo get_template_directory_uri(); ?>/assets/images/watch.png" 
                                class="wathc"
                                alt="">Ver vídeo
                                </button>
                            </a>
