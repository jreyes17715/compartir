...
<section class="descubreSection reveal fade-bottom" id="descubre">
            <h2 class="titleSection animate__backInDown">DESCUBRE</h2>
            <div class="CardsSection">
                <div class="itemSectionDescubre directivosItem reveal fade-left">
                ...
                <div class="itemSectionDescubre docentesItem reveal fade-bottom">
                    <div class="topSectionCard">
                        <h2>DOCENTES</h2>
                ...
                <div class="itemSectionDescubre familasItem reveal fade-right">
                    <div class="topSectionCard">
                        <h2>FAMILIAS</h2>
