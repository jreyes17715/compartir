<div class="modaldescubre">
    <div class="modal-content">
        ...
        <div class="contentModal2">
        	<img src="<?php echo get_template_directory_uri(); ?>/assets/images/close.png" class="close-window2" 
        onclick="toggleModaldescubre();">
        	<div class="contenidoWhatsapp">
        		 <h2>Generar Enlace de Whatsapp</h2>
        		 <p>
        		 	Ingresa el número de teléfono al que desear enviar el documento y haz clic en el botón “Generar enlace de WhatsApp”
        		 </p>
             ...
             <div class="contenidoEmail">
             	<h2>Generar Enlace de Email</h2>
        		 <p>
        		 	Ingresa el correo electrónico al que desees enviar el folleto para directivos y luego presiona el botón “Generar Email” 
        		 </p>
	        	 <input type="text" id="EmailInput" placeholder="Ingresa La direccion de E-mail">
	             <button onclick="generateEmail()" class="btnW2" id="normal">Enviar Email</button>
             </div>
        </div>
