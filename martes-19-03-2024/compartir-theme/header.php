                ...
                <div class="menuItemsGeneral">
                    <nav>
                        <ul>
                            ...
                            <li><a href="#propuesta">NUESTRA PROPUESTA</a></li>
                            <li><a href="#evalua">EVALÚA</a></li>
                            <li><a href="#acompa">ACOMPAÑAMIENTO</a></li>
                        </ul>
                    </nav>
        ...
        <div class="containerNav">
            <nav class="nav-bar">
              ...
              <ul class="nav-menu">
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">NUESTRA PROPUESTA</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">EVALÚA</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">ACOMPAÑAMIENTO</a>
                </li>
              </ul>
